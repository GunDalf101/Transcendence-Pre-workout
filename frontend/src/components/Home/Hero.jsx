...
const Hero = () => {
  ...
  return (
    <section className="bg-gray-800 mt-6 w-full max-w-4xl p-8 rounded-md shadow-lg border-4 border-gray-700 pixelated hover:border-green-500 transform hover:scale-105 transition duration-300">
      <h2 className="text-3xl font-bold text-green-400 pixel-font">
        🎮 Welcome {username || 'Loading...'} to Pong Game 🎮
      </h2>
